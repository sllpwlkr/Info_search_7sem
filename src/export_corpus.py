...
def main():
    ...
    # Словарь для хранения уже обработанных doc_id (проверка уникальности)
    processed_doc_ids = set()

    # Берём только документы, где есть clean_text
    cur = col.find(
    ...
    with open(out_path, "w", encoding="utf-8") as out:
        for doc in cur:
            ...
            # Пропускаем документы с дублирующимся doc_id
